...
import jchess.core.ai.joc_ai.Level1;
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        else if (target == this.okButton) //if clicked OK button (on finish)
        {
            ...
            if (0 == this.color.getSelectedIndex())
            {
                ...
                whiteType = PlayerType.localUser;
                blackType = (this.oponentComp.isSelected()) ? PlayerType.computer :  PlayerType.localUser;
            }
            else
            {
                blackName = playerFirstName;
                whiteName = playerSecondName;
                blackType = PlayerType.localUser;
                whiteType = (this.oponentComp.isSelected()) ? PlayerType.computer :  PlayerType.localUser;
            }
