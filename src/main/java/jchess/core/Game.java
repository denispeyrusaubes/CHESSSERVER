...
public class Game extends JPanel implements ComponentListener, MouseListener
{
    ...
    static public void loadGame(File file)
    {
        ...
        playerBlack.setType(PlayerType.localUser);
        playerWhite.setType(PlayerType.localUser);
    ...
    public void newGame()
    {
        ...
        if (activePlayer.getPlayerType() != PlayerType.localUser)
        {
    ...
    public void nextMove()
    {
        ...
        else if (activePlayer.getPlayerType() == PlayerType.networkUser
    ...
    public boolean simulateMove(int beginX, int beginY, int endX, int endY, String promoted)
    {
        ...
        {
            LOG.error("NullPointerException: " + exc);
            return false;
        }
    }
    ...
    public boolean undo()
    {
        ...
        if(this.getSettings().getGameType() != Settings.gameTypes.network)
        {
